  ...
  jQuery(function($) {
    ...
    recentCartItemPopUp = function() {
      ...
      return $.getJSON("/cart.js", function(cart, textStatus) {
        ...
        cart_item.sellingPlan= cart.items[0].selling_plan_allocation ? cart.items[0].selling_plan_allocation.selling_plan.name : '';
		...
		new_cart_row += '<span>'+cart_item.sellingPlan+'</span>'
        new_cart_row += '</td>';
